## Name: clean_specialchem_polyadds_data.R
## Author: Katherine A. Phillips
## Date Created: February 2015
## Purpose: Cleans up polymer additives data collected from SpecialChem.
...
chems <- read.csv("Cleaned_PolymerAdditives.csv")
chems <- chems[c(1,4,5)]
...
chems$WebURL <- "http://polymer-additives.specialchem.com/"
chems$DownloadDate <- "2014-12-30 00:00:00"
# stop()
...
write.csv(chems,"PolymerAdditives_FunctionalUse_01192016.csv", row.names = FALSE)

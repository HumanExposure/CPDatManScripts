## Name: clean_specialchem_cosmetics_data.R
## Author: Katherine A. Phillips
## Date Created: February 2015
## Purpose: Cleans up cosmetics data collected from SpecialChem.
...
chems <- read.csv("Cleaned_Cosmetics.csv")
chems <- chems[c(1,4,5)]
...
# stop()
chems$Source <- "CosIng (EU)"
chems$WebURL <- "http://ec.europa.eu/growth/tools-databases/cosing/"
chems$DownloadDate <- "2014-07-16 00:00:00"
...
write.csv(chems,"Cosmetics_FunctionalUse_01192016.csv", row.names = FALSE)
